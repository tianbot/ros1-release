...
std::tuple<NodeOptions, TrajectoryOptions> LoadOptions(
  ...
  std::vector<std::string> configuration_directories;
  configuration_directories.push_back(configuration_directory);
  configuration_directories.push_back(
      "/opt/ros/noetic/share/cartographer/configuration_files");
  configuration_directories.push_back(
      "/opt/ros/noetic/share/cartographer_ros/configuration_files");
  auto file_resolver =
