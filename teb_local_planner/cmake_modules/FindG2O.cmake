...
SET(G2O_DIR "/home/sunrise/tianracer_ros1_ws/devel")
...
IF(UNIX)
  ...
  MESSAGE(STATUS "Searching for g2o ...")
  MESSAGE(STATUS "G2O_DIR set to: ${G2O_DIR}")

  FIND_PATH(G2O_INCLUDE_DIR
    NAMES g2o/core/base_vertex.h g2o/stuff/misc.h
    PATHS ${G2O_DIR} /usr/local /usr
  ...
  FIND_LIBRARY(G2O_CORE_LIB             
    ...
    PATHS ${G2O_DIR} /usr/local /usr ${CMAKE_PREFIX_PATH}
    PATH_SUFFIXES lib)
